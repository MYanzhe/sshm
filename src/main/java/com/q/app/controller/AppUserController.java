...
public class AppUserController {
	...
	// 获取列表
	@ResponseBody
	@RequestMapping(value = "app/user/getList", method = { RequestMethod.GET, RequestMethod.POST })
	...
	@ResponseBody
	@RequestMapping(value = "app/user/add", method = { RequestMethod.GET, RequestMethod.POST })
	public String userAdd(Model model, AppUserEntity entity, HttpServletRequest request) {
		if(service.checkPhoneUsable(entity)){
			service.add(entity);
			return "success";
		} else {
			return "phoneUsed";
	...
	@ResponseBody
	@RequestMapping(value = "app/user/login", method = { RequestMethod.GET, RequestMethod.POST })
	public String login(Model model, AppUserEntity entity, HttpServletRequest request) {
		AppUserEntity user = service.login(entity);
		if (user != null) {
